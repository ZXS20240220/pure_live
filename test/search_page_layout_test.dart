...
void main() {
  ...
  for (final platform in [Sites.kuaishouSite, Sites.picartoSite, Sites.openrecSite, Sites.huajiaoSite]) {
  ...
  for (final platform in [Sites.inkeSite, Sites.missevanSite, Sites.kilakilaSite, Sites.twitcastingSite]) {
